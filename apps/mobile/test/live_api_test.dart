...
const bypassCode = String.fromEnvironment('LIVE_OTP_CODE', defaultValue: '000000');

void main() {
  test(
    'full sign-in lifecycle against the real API',
    () async {
      ...
      final verified = await repo.verifyEmailOtp(emailChallenge.challengeId, bypassCode);
      ...
      await expectLater(
        ...
        throwsA(isA<ApiException>().having((e) => e.code, 'code', 'OTP_COOLDOWN')),
      );
