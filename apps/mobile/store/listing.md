...
Borrow and lend near you

## Promotional text (App Store, max 170)
Going on a trek or shooting a wedding? Borrow what you need from verified people nearby, with a refundable deposit and a handover code.
...
• See the price per day, the refundable deposit and how far away it is
• Chat with the lender (your number stays hidden until you book)
• Request to book, share an ID if the lender asks, and pay safely through Razorpay (UPI, cards, net banking)

**Lend**
• List an item in a few minutes with photos, a daily price and a deposit
• Approve who borrows it, and see their verified ID if you ask for one
• Get paid to your bank after the item comes back
...
**Your privacy**
• Phone numbers and addresses are only shared after a booking is confirmed
...
## Category
Play: **Lifestyle**. App Store: primary **Lifestyle**, secondary **Shopping**.

## Contact details
- Email: support@sajha.app
- Website: https://sajha.app
- Privacy policy: https://sajha.app/privacy
- Account deletion: https://sajha.app/delete-account
