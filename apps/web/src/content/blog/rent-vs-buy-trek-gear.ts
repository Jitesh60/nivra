...
export const post: Post = {
  slug: 'rent-or-buy-trekking-gear-pune',
  title: 'Renting vs buying trekking gear for a weekend trek from Pune',
  description:
  ...
  body: [
    {
      p: 'Rajmachi, Harishchandragad, Kalsubai: most Pune trekkers do three or four overnight treks a year, mostly in the monsoon and winter. The gear for them mostly sits in a loft for the other eleven months.',
    },
    { h2: 'What the gear actually costs' },
    {
      ul: [
        'A decent two-person tent: ₹5,000–8,000',
        'A sleeping bag rated for 5 °C: ₹2,500–4,000',
        'Trekking poles: ₹1,200–2,500 a pair',
        'A 50-litre rucksack: ₹3,000–6,000',
      ],
    },
    {
      p: 'That’s ₹12,000 or more before you’ve left the city. Spread over four treks a year it isn’t terrible, but most people buy once, trek twice, and the tent never sees a third monsoon.',
    },
    ...
    { h2: 'When buying still makes sense' },
    {
      ul: [
        'You trek more than eight or ten nights a year.',
        'You need something fitted to you: boots, a harness, a rucksack you’ll carry for days.',
        'You’re going somewhere a rented item can’t easily come back from on time.',
      ],
    },
    {
