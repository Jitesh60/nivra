...
/**
 * Admins see people's phone numbers, emails and documents; none of it may
 * reach Sentry. Drops request bodies, cookies and auth headers, keeps only the
 * admin's id, and masks phones, emails and codes in messages and URLs.
 */
