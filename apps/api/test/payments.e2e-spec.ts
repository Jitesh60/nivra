...
import { verifiedUser } from './helpers/market.js';
import { bearer, PAYOUT, paymentHelpers } from './helpers/payments.js';
...
describe('Payments, refunds & payouts (e2e)', () => {
  ...
  const { awaitingPayment, pay, devCheckout, detail, paid, webhook, ledgerFor, startIn } =
    paymentHelpers(() => ({ app, sms, prisma, fake }));
